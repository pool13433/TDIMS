...
INSERT INTO `sim` (`sim_id`, `mobile_no`, `serial_no`, `imsi`, `charge_type`, `region_code`, `system`, `env_id`, `usage_type`, `owner`, `team_id`, `email_contact`, `project_id`, `valid_date`, `expire_date`, `remark`, `create_date`, `create_by`, `update_date`, `update_by`, `sim_status`) VALUES
(1, '08000000001', '0800000000', '0800000000', 'prepaid', '0800000000', '', 1, 'physical', 0, 2, 'BOSD_Dev@ais.postbox.in.th;', 1, '2017-03-10', '2017-03-30', 'MAMA', '2017-02-26', 1, '2017-03-10', 1, 'Unavaliable'),
(11, '021111111', '021111111', '021111111', 'prepaid', '021111111', '', 0, 'physical', 0, 1, 'booking now', 1, '2017-03-03', '2017-04-03', 'Remark NO non', '2017-02-26', 1, '2017-03-09', 1, 'Pending'),
(12, 'md5', 'md5', 'md5', 'prepaid', 'md5', '', 0, 'physical', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2017-02-27', 1, '2017-02-27', 1, 'available'),
(13, 'Interstellar', 'Interstellar', 'Interstellar', 'postpaid', 'Interstellar', '', 0, 'physical', 0, NULL, NULL, NULL, NULL, NULL, NULL, '2017-02-27', 1, '2017-02-27', 1, 'available');
...
INSERT INTO `testcase` (`testcase_id`, `testcase_title`, `testcase_details`, `systems`, `enviroment`, `defect_no`, `issue_no`, `project_id`, `path_dir`, `user_id`, `create_date`) VALUES
(1, 'Test Call BOS Store Procedure Error', 'Test Call BOS Store Procedure Error. getPaymentMoneyNullError not success.', 'BOS', 'BOS', 'T170303001', '1', '1', 'D://Knowledge/1', 'nan', '2017-03-07 04:47:54'),
(2, 'Test RTBS + Support Report Ccare', 'Test RTBS + Support Report Ccare. issue case hybrid, change charge type by account.', 'RTBS', 'IRB', 'T170303002', '2', '2', 'D://Knowledge/2', 'nan', '2017-03-07 04:48:09');
